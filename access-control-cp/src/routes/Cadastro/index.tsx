        ...
        <form className="cadastrarUser" onSubmit={onSubmit}>
          <fieldset>
            ...
            <div>
              ...
              <input type="text" id="nome" className="bg-amber-50" {...register("nome", {required: true, maxLength: 200, minLength: 2,})} aria-invalid={!!errors.nome} aria-describedby={errors.nome ? "nome-error" : undefined}/>
              {errors.nome && (<div id="nome-error" role="alert">
                {errors.nome.type === "required" && <span className="text-red-900">*O nome é obrigatório.</span>}
                {errors.nome.type === "minLength" && <span className="text-red-900">*O nome deve ter no mínimo 2 caracteres.</span>}
                {errors.nome.type === "maxLength" && <span className="text-red-900">*O nome deve ter no máximo 200 caracteres.</span>}
              </div>)}
            </div>
            <div>
